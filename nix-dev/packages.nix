...
let
    ...
    paths = with pkgs; [
      ...
      #Write fish configuration for shell. 
      #TODO: Can we do better than this? How can we ensure we read directly from the repo, not the local system when this gets used?
